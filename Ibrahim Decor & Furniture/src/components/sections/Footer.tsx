    ...
    <footer className="bg-gradient-to-b from-background to-amber-50/20 dark:to-amber-950/10 border-t border-foreground/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-foreground/10 pt-8 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-2 mt-4 text-xs text-foreground/40">
            <span>Developed & Managed by</span>
            <span className="font-semibold text-amber-700/60 dark:text-amber-500/60">
              Nikhil Dhiman
            </span>
            <span className="hidden md:inline">•</span>
            <a
              href="tel:+917876750648"
              className="hover:text-amber-600 transition-colors"
            >
              +91 7876750648
            </a>
            <span className="hidden md:inline">•</span>
            <a
              href="mailto:nikhilstackron@gmail.com"
              className="hover:text-amber-600 transition-colors"
            >
              nikhilstackron@gmail.com
            </a>
          </div>
        </div>
      </div>
